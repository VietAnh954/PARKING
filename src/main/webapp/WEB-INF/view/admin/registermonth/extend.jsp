                ...
                <div class="container mt-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form:form action="${pageContext.request.contextPath}/admin/registermonth/extend"
                                method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="soThang" id="1thang"
                                            value="1" checked>
                                        <label class="form-check-label" for="1thang">1 tháng</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="soThang" id="6thang"
                                            value="6">
                                        <label class="form-check-label" for="6thang">6 tháng</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="soThang" id="12thang"
                                            value="12">
