                                        ...
                                        <div class="col-12 mx-auto">
                                            ...
                                            <div class="row mb-3 align-items-center">
                                                <div class="col-lg-8 col-md-12 mb-2 mb-lg-0 d-flex align-items-center">
                                                    <form action="<c:url value='/admin/registermonth/search'/>"
                                                        method="get" class="d-flex flex-grow-1">
                                                        <input type="text" name="tuKhoa" class="form-control mr-2"
                                                            placeholder="Nhập biển số xe..." value="${param.tuKhoa}">
                                                        <button type="submit"
                                                            class="btn btn-primary mr-3 text-nowrap">Tìm
                                                            kiếm</button>
                                                    </form>
                                                </div>
                                                <div class="col-lg-4 col-md-12 text-lg-end text-md-start mt-2 mt-lg-0">
                                                    <a href="<c:url value='/admin/registermonth/create'/>"
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12 text-center">
                                                    <div class="btn-group" role="group">
                                                        <a href="<c:url value='/admin/registermonth/active'/>"
                                                            class="btn btn-success mx-1">Đăng
                                                            ký còn hiệu lực</a>
                                                        ...
                                                        <a href="<c:url value='/admin/registermonth'/>"
                                                            class="btn btn-secondary mx-1">Tất
                                                            cả</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <nav>
                                                <ul class="pagination justify-content-center">
                                                    ...
                                                    <c:forEach begin="0" end="${registerMonthPage.totalPages - 1}"
                                                        var="i">
                                                        <li
                                                            class="page-item ${i == registerMonthPage.number ? 'active' : ''}">
                                                            <a class="page-link"
                                                                href="?page=${i}&size=${registerMonthPage.size}">${i +
                                                                1}</a>
                                                        </li>
                                                    </c:forEach>
