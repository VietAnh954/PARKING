                                ...
                                <div class="container mt-4">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            <h3>Tạo tài khoản cho ${userType == 'student' ? 'sinh viên' : 'nhân viên'}
                                                ${userId}
                                            </h3>
                                            <hr />
                                            <form method="post" action="/admin/account/create" id="createAccountForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="123 (đã mã hóa)"
                                                        readonly />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Vai trò:</label>
                                                    <select name="roleId" class="form-select" required>
                                                        <option value="" disabled ${selectedRole==null ? 'selected' : ''
                                                            }>Chọn vai
                                                            trò</option>
                                                        <c:forEach var="role" items="${roles}">
                                                            <option value="${role.roleID}" ${role.roleID==selectedRole
                                                                ? 'selected' : '' }>
                                                                ${role.roleName}
                                                            </option>
                                                        </c:forEach>
